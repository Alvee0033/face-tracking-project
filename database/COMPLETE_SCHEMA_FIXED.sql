...
-- ============================================
-- ENUMS (Required for tables below)
-- ============================================
...
-- ============================================
-- TABLES (Fixed USER-DEFINED types)
-- ============================================
...
CREATE TABLE IF NOT EXISTS public.candidate_profiles (
  ...
  headline text,
  date_of_birth date,
  profile_type profile_type NOT NULL DEFAULT 'Professional'::profile_type,
...
CREATE TABLE IF NOT EXISTS public.calls (
  ...
  caller_type user_role NOT NULL,
  caller_id uuid NOT NULL,
  status call_status NOT NULL DEFAULT 'initiated'::call_status,
...
CREATE TABLE IF NOT EXISTS public.candidate_education (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  candidate_id uuid NOT NULL,
  education_type education_type NOT NULL DEFAULT 'Undergraduate'::education_type,
...
CREATE TABLE IF NOT EXISTS public.candidate_experience (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  candidate_id uuid NOT NULL,
  experience_type experience_type NOT NULL DEFAULT 'Full-time Job'::experience_type,
  job_title text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.candidate_learning_roadmaps (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  candidate_id uuid NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS public.candidate_other_links (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  candidate_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.job_skill_recommendations (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  job_id uuid NOT NULL,
  candidate_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.professional_headshots (
